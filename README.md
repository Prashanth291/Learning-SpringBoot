...
The repository serves as a **learning workspace** where I explore and practice:

- Spring Boot fundamentals
- RESTful API development
- Spring Data JPA & Hibernate
- Database integration using H2 (and later relational databases)
- Project structuring and best practices in backend development
...
- Understand JPA entity relationships and persistence  
...
I am a **B.Tech student** with a strong interest in **Data Structures, Algorithms, and Backend Development**.  
I enjoy building backend systems and continuously improving my understanding of scalable and maintainable software.
